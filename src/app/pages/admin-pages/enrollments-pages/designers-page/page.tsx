...
const PageIndex= ()=> {
    ...
    return (        
        <div className="lg:col-span-4 h-full w-[90%] mx-auto mt-[20px] flex flex-col items-center gap-y-[50px]">
            ...
            <Tooltip content="Add New Designer">
              <Link href={"/pages/admin-pages/enrollments-pages/designers-page/add-new-designer-page"} className="text-4xl text-white text-center flex justify-center items-center fixed bottom-12 right-12 bg-orange-800 size-[60px] rounded-full border-2 border-orange-100 shadow-sm shadow-gray-800">
                  +
              </Link>
            </Tooltip>
